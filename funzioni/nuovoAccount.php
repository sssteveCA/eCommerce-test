...
if(isset($_POST['nome'],$_POST['cognome'],$_POST['nascita'],$_POST['sesso'],$_POST['indirizzo'],$_POST['numero'],$_POST['citta'],$_POST['cap'],$_POST['email'],$_POST['user'],$_POST['password'],$_POST['confPass'])){
...
HTML;
        ...
        $risposta['msg'] = Msg::ERR_PWDNOTEQUAL;
    }
